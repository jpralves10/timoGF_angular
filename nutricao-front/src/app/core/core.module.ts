...
import {TesteData} from './data/testes';
...
import {TesteService} from './http/teste.service';
...
import {TesteMockService} from './mock/testes-mock.service';
...
export const SERVICES_PROVIDERS = [
  ...
  {provide: TesteData, useClass: environment.mock ? TesteMockService : TesteService},
